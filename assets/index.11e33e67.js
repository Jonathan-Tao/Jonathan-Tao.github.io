...
#define LOW_PRECISION`),t}function Cp(s){let t="SHADOWMAP_TYPE_BASIC";return s.shadowMapType===va?t="SHADOWMAP_TYPE_PCF":s.shadowMapType===Dl?t="SHADOWMAP_TYPE_PCF_SOFT":s.shadowMapType===ci&&(t="SHADOWMAP_TYPE_VSM"),t}function Pp(s){let t="ENVMAP_TYPE_CUBE";if(s.envMap)switch(s.envMapMode){case ws:case bs:t="ENVMAP_TYPE_CUBE";break;case Ss:case Es:t="ENVMAP_TYPE_CUBE_UV";break}return t}function Dp(s){let t="ENVMAP_MODE_REFLECTION";if(s.envMap)switch(s.envMapMode){case bs:case Es:t="ENVMAP_MODE_REFRACTION";break}return t}function Ip(s){let t="ENVMAP_BLENDING_NONE";if(s.envMap)switch(s.combine){case wr:t="ENVMAP_BLENDING_MULTIPLY";break;case Kl:t="ENVMAP_BLENDING_MIX";break;case $l:t="ENVMAP_BLENDING_ADD";break}return t}function Np(s,t,e,n){const i=s.getContext(),r=e.defines;let o=e.vertexShader,a=e.fragmentShader;const l=Cp(e),c=Pp(e),h=Dp(e),u=Ip(e),d=s.gammaFactor>0?s.gammaFactor:1,f=e.isWebGL2?"":wp(e),m=bp(r),x=i.createProgram();let v,p,g=e.glslVersion?"#version "+e.glslVersion+`
